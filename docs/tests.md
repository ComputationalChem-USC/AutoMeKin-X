...
{: .highlight}   
Some tests can be run [using this Notebook](https://colab.research.google.com/github/ComputationalChem-USC/AutoMeKin-X/blob/main/notebooks/AutoMeKin2.ipynb)
